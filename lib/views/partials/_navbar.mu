  ...
  <div class="container-fluid">
    ...
    <nav class="" role="navigation">
      ...
      <ul class="nav navbar-nav navbar-right secondary-nav">
        ...
        <li class="ext-link"><a href="//linkedin.com/in/adamgruber" id="linkedin" target="_blank" title="Hire me."><i class="fa fa-2x fa-linkedin-square"></i></a></li>
        <li class="ext-link" style="display: none;"><a href="#" id="email" title="Email me."><i class="fa fa-2x fa-envelope-square"></i></a></li>
      </ul>
    </nav>
  </div>
</div>